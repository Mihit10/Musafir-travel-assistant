...
import './Loader.css'; // Assuming you save the CSS in Loader.css

interface LoaderProps {
  isLoading: boolean;
  loadingText?: string; // Optional loading text, defaults to "Loading..."
}

const Loader: React.FC<LoaderProps> = ({ isLoading, loadingText = "Loading... Please wait" }) => {
  if (!isLoading) {
    return null; // Don't render the loader if isLoading is false
  }
