...
const IndiaMandala = () => {
  ...
  const calculateMovement = (baseDistance: number, direction: number) => {
    const moveAmount = Math.min(
      baseDistance * (scrollPosition / 1000),
      baseDistance
    );
  ...
  return (
    <div ref={sectionRef} className="mandala-section w-full h-full absolute">
      <div className="mandala-container w-full h-full">
        <div className={`mandala-wrapper ${isVisible ? "visible" : "hidden"}`}>
          ...
          {/* Input Box */}
          <div
            className={`mandala-input ${isVisible ? "visible" : "hidden"} ${
              showInput ? "show" : ""
            }`}
          >
            // Updated submit button with href navigation
            <div className="input-container">
              ...
              <button
                ...
                onClick={() => {
                  const state = "Himachal"; // Replace with dynamic data if necessary
                  const check_in_date = "2025-06-18"; // Replace with dynamic data
                  const check_out_date = "2025-06-25"; // Replace with dynamic data
                  const preferences = ["nature", "adventure", "heritage"]; // Replace with dynamic data
          ...
          {/* Peacock 1 - Top Left */}
          <div
            className={`mandala-component peacock-left ${
              isVisible ? "visible" : "hidden"
            }`}
            style={{
              transform: `translate(-30px, -80px) translate(${calculateMovement(
                100,
                -1
              )}px, ${calculateMovement(20, -1)}px)`,
            }}
          >
            <div className="component-image-container">
              <img src="/p2.gif" alt="Peacock" className="component-image" />
            </div>
          </div>

          {/* Peacock 2 - Top Right */}
          <div
            className={`mandala-component peacock-right ${
              isVisible ? "visible" : "hidden"
            }`}
            style={{
              transform: `translate(-82px, -80px) translate(${calculateMovement(
                100,
                -1
              )}px, ${calculateMovement(20, -1)}px)`,
            }}
          ...
          <div
            className={`mandala-component elephant-right ${
              isVisible ? "visible" : "hidden"
            }`}
            style={{
          ...
          <div
            className={`mandala-component elephant-left ${
              isVisible ? "visible" : "hidden"
            }`}
            style={{
              transform: `translate(${calculateMovement(
          ...
          {/* Fort - Bottom */}
          <div
            className={`mandala-component component-bottom ${
              isVisible ? "visible" : "hidden"
            }`}
            style={{
          ...
          >
            <div className="component-image-container">
              <img src="/fort.png" alt="Fort" className="component-image" />
            </div>
          </div>
        </div>
      </div>
